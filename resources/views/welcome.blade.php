        ...
        <div class="bauhaus-card relative p-8 lg:p-10">
            ...
            <div class="grid gap-8 md:grid-cols-2">
                <a
                    ...
                    class="group flex flex-col items-center gap-5 border border-bauhaus-black bg-bauhaus-paper p-8 text-center transition-transform duration-100 hover:-translate-y-1 hover:bg-bauhaus-paper-dark"
                >
            ...
            <div class="mt-8 flex items-center gap-4 border-t border-bauhaus-black pt-6">
                ...
                <a href="{{ route('laporan.status') }}" class="bauhaus-btn bg-bauhaus-paper px-4 py-2 text-xs">Lacak →</a>
            </div>

            <div class="mt-6 flex items-center gap-4 border-t border-bauhaus-black pt-6">
                ...
                <a href="{{ route('laporan.saya') }}" class="bauhaus-btn bg-bauhaus-paper px-4 py-2 text-xs">Laporan Saya →</a>
            </div>
            ...
            <div class="mt-6 flex items-center gap-4 border-t border-bauhaus-black pt-6">
                ...
                <a href="{{ route('aset.index') }}" class="bauhaus-btn bg-bauhaus-paper px-4 py-2 text-xs">Cari Aset →</a>
            </div>
        </div>
    </div>
</x-bauhaus.layout>
